  ...
  render() {
    ...
    return (
      <ul className="nav" ref={(c) => { this.nav = c; }}>
        ...
        <li><Button href="#/app/articlepane"><i className="nav-icon material-icons">chrome_reader_mode</i><span className="nav-text">Articles</span></Button></li>
        {/*<li><Button className="prepend-icon" href="#/app/articleblog/article_1"><span>Article Test</span></Button></li>*/}
        ...
        {/*</li>*/}
        <li className="nav-divider" />
        <li className="nav-header"><span>Information</span></li>
        <li><Button href="#/app/aboutus"><i className="nav-icon material-icons">people</i><span className="nav-text">About Us</span></Button></li>
        <li><Button href="#/app/contactus"><i className="nav-icon material-icons">phone</i><span className="nav-text">Contact Us</span></Button></li>
      </ul>
    );
  }
}

        ...
        return (
            <section className="app-header">
                ...
                >
                    ...
                    <div className="brand d-none d-lg-inline-block d-xl-inline-block p">
                        <h2><small><Link to="/">{APPCONFIG.brand}</Link></small></h2>
                    </div>

                    <div className="brand ml-xl-4 top-nav-left d-none d-lg-inline-block d-xl-inline-block">
                        <NavLeftList />
                    </div>
